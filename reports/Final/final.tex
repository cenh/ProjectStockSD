...
\begin{enumerate}
	\item \begin{itemize}
		...
		\item Mål: Find information om projekt fra katalog
		\begin{enumerate}
			\item\label{a1} Den studerende går ind på 'Project Stock'-siden
			\item\label{a2} Siden præsenterer muligheden for at se et katalog over projekter
			\item\label{a3} Den studerende vælger at se kataloget med projekterne
			\item\label{a4} Katalog bliver nu præsenteret på siden
			\item\label{a5} Den studerende udvælger sig et projekt fra kataloget
			\item\label{a6} Siden præsenterer information for det pågældene projekt
		\end{enumerate}
		\item Udvidelser:
		\begin{itemize}
		\item \ref{a2} Siden præsenterer ikke information som ønsket
		\begin{itemize}
			\item \ref{a2}. Fejlbesked bliver præsenteret
		\end{itemize}
		\item \ref{a3} Den studerende vælger noget andet end at se kataloget
		\begin{itemize}
			\item \ref{a3} Siden præsenterer fortsat muligheden for at se kataloget
		\end{itemize}
	  \end{itemize}
		\item Variationer:
		\begin{enumerate}
