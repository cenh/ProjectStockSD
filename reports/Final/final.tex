...
\title{
  ...
  \Large{Software Udvikling 2016 - Hold 01;, Project-Stock, Project-Stock 3} \\
  \large{Repository: ProjectStockSD} \\
  Vejledere: Patrick Krøll Brandt \& Jonathan Schrøder Holm Hansen
	}
...
\begin{enumerate}
  ...
  \item Kør den valgte test ved at skrive \texttt{robot ____Test.robot} eksempelvis \\
...
\subsection{Bilag B}
\label{sec:bilagB}
Man kan hente vores release på følgende link, i arkivet ligger der en fil kaldet INSTALL.md som vil forklarer hvordan man kører vores hjemmeside lokalt, men også hvordan man kører vores tests:
