...
\\
Django har en masse filer, der har ansvar for mange forskellige ting, så vi har derfor beskrevet filstrukturen i afsnit \ref{sec:struktur}.
...
Det er vigtigt at personen (\textit{moderator}), der står for reviewet ikke også selv har skrevet kode, da man kan stirre sig blind på sine egne fejl, og dermed utilsigtet føre fokus et forkert sted hen.\\
\\
For at forbedre inspektioner kan data indsamles fra hver inspektion og herefter flettes ind i nye inspektioner.\\
\\
Vi har ikke udført nogle formelle inspektioner, udover i review-sessionerne 3 og 4.\\%reference?
I session 3 blev der ikke tilstrækkeligt forberedt fra hverken den ene eller den anden gruppe, hvilket skyldtes kommunikationsproblemer mellem grupperne og instruktorerne. Da det er et krav, at der skal være forberedt til reviews, førte dette til, at der ikke blev udført reviews i denne session.\\
% forklar review 4
\\
\\
