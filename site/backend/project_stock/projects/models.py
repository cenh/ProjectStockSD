...
class Project(models.Model):
    ...
    description_short = models.TextField('Short description', max_length=256, blank=True, null=True)
    description_long = models.TextField('Long description', blank=True, null=True)
    website = models.URLField(max_length=128, blank=True, null=True)
